...
import com.breakingthebasics.model.Gson_Remi;
...
public class ReminderActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String strdays = "", strtime = "12:00", u_id = "", reminder = "", notify = "";
...
//    private boolean isremind = false, isday = false, istime = false;
    ...
    public void setMarginTop() {
        ...
        params.setMargins(5, myPref.getstatusHeight(), 0, 0);
...
//                istime = true;
                strtime = strHrsToShow + ":" + datetime.get(Calendar.MINUTE) + " " + am_pm;
